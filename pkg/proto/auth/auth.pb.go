...
type RegisterRequest struct {
	...
	Login         string                 `protobuf:"bytes,1,opt,name=login,proto3" json:"login,omitempty"`       // User login (unique)
	Password      string                 `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // User password (will be hashed)
...
const file_proto_auth_auth_proto_rawDesc = "" +
	...
	"\n" +
	"updated_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt2\x8b\x02\n" +
	"\vAuthService\x129\n" +
	...
	"\fRefreshToken\x12\x19.auth.RefreshTokenRequest\x1a\x1a.auth.RefreshTokenResponseB5Z3github.com/fylgushev/go-diplom-final/pkg/proto/authb\x06proto3"
...
var file_proto_auth_auth_proto_depIdxs = []int32{
	9,  // 0: auth.RegisterResponse.expires_at:type_name -> google.protobuf.Timestamp
	...
	9,  // 5: auth.User.created_at:type_name -> google.protobuf.Timestamp
	9,  // 6: auth.User.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 7: auth.AuthService.Register:input_type -> auth.RegisterRequest
	2,  // 8: auth.AuthService.Login:input_type -> auth.LoginRequest
	4,  // 9: auth.AuthService.ValidateToken:input_type -> auth.ValidateTokenRequest
	...
	5,  // 13: auth.AuthService.ValidateToken:output_type -> auth.ValidateTokenResponse
